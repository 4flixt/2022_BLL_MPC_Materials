...
def main():
    ...
    # Add variables
    sp.set_sampling_var('w_ref', lambda: np.random.uniform(6,16))
    sp.set_sampling_var('E_0', lambda: np.random.uniform(5,8))
    ...
    plan = sp.gen_sampling_plan(n_samples = 100)

    sp.export('kite_sampling_01_plan')
